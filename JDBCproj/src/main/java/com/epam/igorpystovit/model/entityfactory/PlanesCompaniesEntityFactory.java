...
public class PlanesCompaniesEntityFactory extends EntityFactory<PlanesCompaniesEntity> {
    @Override
    protected PlanesCompaniesEntity createEntity() {
        ...
        return new PlanesCompaniesEntity(planeCompanyId,companyId,planeId,availableSeats);
    }
}
